    ...
    private static readonly ushort[] ExplicitlyBlockedHeldItems =
{
    ...
    public static string PokeImg(PKM pkm, bool canGmax, bool fullSize, ImageSize? preferredImageSize = null)
    {
        ...
        if (fullSize)
        {
            baseLink = "https://raw.githubusercontent.com/Secludedly/ZE-PokedexMasterBot-HOME-Images/master/512x512/poke_capture_0001_000_mf_n_00000000_f_n.png".Split('_');
        }
        else if (preferredImageSize.HasValue)
        {
            baseLink = preferredImageSize.Value switch
            {
                ImageSize.Size256x256 => "https://raw.githubusercontent.com/Secludedly/ZE-PokedexMasterBot-HOME-Images/master/256x256/poke_capture_0001_000_mf_n_00000000_f_n.png".Split('_'),
                ImageSize.Size128x128 => "https://raw.githubusercontent.com/Secludedly/ZE-PokedexMasterBot-HOME-Images/master/128x128/poke_capture_0001_000_mf_n_00000000_f_n.png".Split('_'),
                _ => "https://raw.githubusercontent.com/Secludedly/ZE-PokedexMasterBot-HOME-Images/master/256x256/poke_capture_0001_000_mf_n_00000000_f_n.png".Split('_'),
            };
        }
        else
        {
            baseLink = "https://raw.githubusercontent.com/Secludedly/ZE-PokedexMasterBot-HOME-Images/master/256x256/poke_capture_0001_000_mf_n_00000000_f_n.png".Split('_');
        }
        ...
        if (pkm.Species is (ushort)Species.Basculegion)
        {
            ...
            return "https://raw.githubusercontent.com/Secludedly/ZE-PokedexMasterBot-HOME-Images/master/256x256/poke_capture_0" + $"{pkm.Species}" + "_00" + $"{pkm.Form}" + "_" + $"{g}" + "_n_00000000_f_" + $"{s}" + ".png";
        }
